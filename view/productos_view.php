...
<body class="bg-light">
  ...
  <?php
  $action = 'listar';
  $data = include("php/productos.php");
            ...
            <tbody>
              <?php foreach ($productos_activos as $row): ?>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-warning" onclick='editar(<?= $row['id_producto'] ?>, <?= json_encode($row['modelo']) ?>, <?= $row['precio_actual'] ?>)'>Editar</button>
                    <a href="php/productos.php?action=desactivar&id=<?= $row['id_producto'] ?>" class="btn btn-sm btn-danger">Desactivar</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
